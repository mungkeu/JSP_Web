...
<body>
<%
	// 화면에 보여질 게시글의 개수를 지정한다.
	int pageSize=10;
	// 현재 카운터를 클릭한 번호값을 읽어온다.
	String pageNum = request.getParameter("pageNum");
	// 만일 처음 boardlist.jsp를 클릭하거나 수정 삭제 등 다른 게시글에서 이 페이지로 넘어오면 pageNum값이 없기에
	// null처리를 해준다.
	if(pageNum==null){
		pageNum="1";
	}
